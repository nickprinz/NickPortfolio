...
export default function AdjustmentsInput({hue, sat, val, onHueChange, onSatChange, onValChange, disabled= false}){
    ...
    <div className="flex flex-row items-center">
        ...
        <NumberInput onValueChange={onValChange} labelText={translate("val")} value={val || ""} min={-100} max={100} disabled={disabled}></NumberInput>
    </div>
    </>
}