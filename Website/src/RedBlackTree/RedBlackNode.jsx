...
export default function RedBlackNode({x, y, value}){
    return <div className="absolute size-20 rounded-full bg-radient-ellipse-c from-red-500 to-red-400 to-80% hover:from-rose-400 hover:to-rose-300 hover:to-80% 
    border-2 border-b-red-950 border-x-red-900 border-t-red-800 
