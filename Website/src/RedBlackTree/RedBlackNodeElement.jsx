...
export default function RedBlackNodeElement({onClick, x, y, value, isRed, isSmall}){
    ...
    return <div onClick={onClick} className={`${alwaysClasses} ${size} ${colorClasses} ${textSize}`}
