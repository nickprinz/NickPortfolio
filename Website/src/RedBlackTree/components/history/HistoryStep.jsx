...
export default function HistoryStep({historyStep, historyStepIndex, historyActionIndex, isActiveStep}){
    
    const { t: translate } = useTranslation("red_black");
    const dispatch = useDispatch();

    const stepTextInfo = useSelector(state => {
        return treeSelectors.getTextForHistoryStep(state, historyActionIndex, historyStepIndex);
    })
